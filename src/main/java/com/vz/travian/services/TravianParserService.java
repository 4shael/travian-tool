...
public class TravianParserService
{
    ...
    Logger logger = LoggerFactory.getLogger(TravianParserService.class);
    ...
    public List<MapResponse.Response.Map.Cell> findWithUnits(List<MapResponse.Response.Map.Cell> oasisList)
    {
    ...
    public List<MapResponse.Response.Map.Cell> getOasises() throws URISyntaxException
    {
